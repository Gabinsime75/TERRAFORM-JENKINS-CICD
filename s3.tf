...
resource "aws_s3_bucket_versioning" "mybucket-versioning" {
...
resource "aws_s3_bucket_ownership_controls" "mybucket-own-contr" {
  bucket = aws_s3_bucket.mybucket.id
...
resource "aws_s3_bucket_public_access_block" "mybucket-pab" {
  bucket = aws_s3_bucket.mybucket.id
